#!/usr/bin/env python3
# Graham S. Paul - 100-lfu_cache.py
"""This displays the Least Frequently Used caching module.
"""
...
class LFUCache(BaseCaching):
    ...
    getting back items from a dictionary with a LFU
    ...
    def __reorder_items(self, mru_key):
        """Sort the items in this cache based on the most
        recently used item.
        """
        max_positions = []
        mru_freq = 0
